...
// Adapter wraps a Client with a pre-configured access token and implements storefrontadapter.Adapter.
type Adapter struct {
	client      *Client
	accessToken string
}
...
func NewAdapter(client *Client, accessToken string) storefrontadapter.Adapter {
