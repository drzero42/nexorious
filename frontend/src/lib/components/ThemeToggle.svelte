...
<div class="relative">
  ...
  <button
    ...
    class="btn btn-ghost btn-sm p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
  ...
  {#if showDropdown}
    <div 
      id="theme-dropdown"
      class="absolute right-0 mt-2 w-36 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50 animate-scale-in"
      role="menu"
