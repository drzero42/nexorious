<script lang="ts">
  import type { StorefrontSuggestion } from '$lib/types/platform-resolution';
  ...
  <div class="flex items-center space-x-3 flex-1">
    ...
    <div class="flex-1 min-w-0">
      <h5 class="text-sm font-medium text-gray-900 truncate">
        {suggestion.storefront_display_name}
      </h5>
...
{#if suggestion.confidence >= 0.85}
  <div class="mt-2 text-xs text-gray-600 bg-green-50 rounded-md p-2 border border-green-200">
    <div class="flex items-center">
      ...
      <span class="ml-1 text-green-700">High confidence storefront match</span>
    </div>
  </div>
