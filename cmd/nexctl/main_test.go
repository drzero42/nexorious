...
func TestRootCmd_Structure(t *testing.T) {
	...
	want := map[string]bool{"version": false, "account": false, "profile": false, "game": false, "tag": false, "pool": false, "sync": false, "job": false, "import": false, "export": false, "backup": false, "login": false, "logout": false}
