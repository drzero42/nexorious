"""initial schema with integer game primary keys

Revision ID: 57c2948f541b
Revises:
Create Date: 2025-09-08 20:33:02.386614
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "external_id", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
            "game_name", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=False
        ),
        sa.Column("igdb_id", sa.Integer(), nullable=True),
        sa.Column(
            "igdb_title", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "user_id", "external_id", name="uq_darkadia_games_user_external"
        ),
    )
    with op.batch_alter_table("darkadia_games", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_darkadia_games_external_id"), ["external_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_games_game_id"), ["game_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_games_igdb_id"), ["igdb_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_games_user_id"), ["user_id"], unique=False
        )
    ...
    with op.batch_alter_table("import_jobs", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_import_jobs_source"), ["source"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_import_jobs_status"), ["status"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_import_jobs_user_id"), ["user_id"], unique=False
        )
    ...
    with op.batch_alter_table("steam_games", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_steam_games_game_id"), ["game_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_steam_games_igdb_id"), ["igdb_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_steam_games_steam_appid"), ["steam_appid"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_steam_games_user_id"), ["user_id"], unique=False
        )
    ...
    with op.batch_alter_table("user_games", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_user_games_game_id"), ["game_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_user_games_is_loved"), ["is_loved"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_user_games_play_status"), ["play_status"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_user_games_user_id"), ["user_id"], unique=False
        )
    ...
    with op.batch_alter_table("wishlists", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_wishlists_game_id"), ["game_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_wishlists_user_id"), ["user_id"], unique=False
        )
    ...
    with op.batch_alter_table("user_game_platforms", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_user_game_platforms_platform_id"),
            ["platform_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_user_game_platforms_user_game_id"),
            ["user_game_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("user_game_tags", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_user_game_tags_tag_id"), ["tag_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_user_game_tags_user_game_id"), ["user_game_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "user_game_platform_id", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.Column(
            "csv_file_hash", sqlmodel.sql.sqltypes.AutoString(length=64), nullable=False
        ),
        ...
        sa.Column(
            "resolved_platform_id", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "resolved_storefront_id", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_game_platform_id"],
            ["user_game_platforms.id"],
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
    ...
    with op.batch_alter_table("darkadia_imports", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_darkadia_imports_batch_id"), ["batch_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_imports_game_name"), ["game_name"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_imports_import_timestamp"),
            ["import_timestamp"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_imports_platform_resolved"),
            ["platform_resolved"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_imports_storefront_resolved"),
            ["storefront_resolved"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_imports_user_game_id"),
            ["user_game_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_imports_user_game_platform_id"),
            ["user_game_platform_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_darkadia_imports_user_id"), ["user_id"], unique=False
        )
