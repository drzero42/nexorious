...
class TestIGDBServiceBusinessLogic:
    ...
    def test_rank_games_by_fuzzy_match_scoring(self):
        ...
        result = service._rank_games_by_fuzzy_match(
            games, "The Witcher 3: Wild Hunt", threshold=0.5
        )
...
class TestStorageServiceBusinessLogic:
    ...
    def test_ensure_directories_creation(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "app.services.storage.settings.storage_path", str(test_storage_path)
        )
    ...
    def test_get_cover_art_filename_generation(self):
        ...
        filename = service.get_cover_art_filename(
            "game-123", "https://example.com/image.jpg"
        )
        assert filename == "game-123.jpg"

        # Test with URL without extension
        filename2 = service.get_cover_art_filename(
            "game-456", "https://example.com/image"
        )
        assert filename2 == "game-456.jpg"  # Default extension

        # Test with different extension
        filename3 = service.get_cover_art_filename(
            "game-789", "https://example.com/image.png"
        )
    ...
    def test_get_cover_art_path_generation(self):
        ...
        path2 = service.get_cover_art_path(
            "different-game", "https://example.com/image.png"
        )
...
class TestGameMetadataBusinessLogic:
    ...
    def test_game_metadata_minimal_creation(self):
        ...
        metadata = GameMetadata(igdb_id=123, title="Minimal Game")
    ...
    def test_game_metadata_string_representation(self):
        ...
        metadata = GameMetadata(igdb_id=456, title="String Test Game")
    ...
    def test_play_status_enum_values(self):
        ...
        for expected in expected_statuses:
            assert expected in enum_values, (
                f"Expected status '{expected}' not found in PlayStatus enum"
            )
...
class TestPydanticRatingValidation:
    ...
    def test_valid_rating_in_schema(self):
        ...
        for rating in [1.0, 2.5, 3.0, 4.5, 5.0]:
            ...
            schema = UserGameCreateRequest(game_id=1, personal_rating=rating)
    ...
    def test_invalid_rating_too_low(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            UserGameCreateRequest(game_id=1, personal_rating=0.5)
    ...
    def test_invalid_rating_too_high(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            UserGameCreateRequest(game_id=1, personal_rating=5.5)
    ...
    def test_null_rating_is_valid(self):
        ...
        schema = UserGameCreateRequest(game_id=1, personal_rating=None)
